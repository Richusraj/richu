...
# 2 ways
    ...
    # 1.
# sample_list=[1,2,3,4,"hello",22,[2,3,3,3,] ]
...
# # sample_list=[1,2,3,4,"hello",22,[2,3,3,7,3,] ]
...
# #     2.    
# sample_list2=list("ss")
# print(sample_list2)

# sample_list2=list([1,"ww",22,])
# print(sample_list2)
...
# # operators in datastructure


#         # += assignment operators
# num=[1,2,3,4,5,6,7,8,9]
# # num+=10 error because[] is important
# num+=[10]
# print(num)
...
# num=[1,2,3,4,5,6,7,8,9,[33,44,55]]
# print(33 in num[-1])
...
# name=["richu","rono","messi",1,2,3,4,5,6,[22,44,55]]
# print(name[1][2])



# # slicing in datastructers
...
# sample_list=["hello","bro",'yoo',"haaa"]
# # x,y,z=sample_list
# print(x)
# print(y)
# print(z)
...
# list methords
# sample_list=["hello","bro",'yoo',"haaa",2,3,4,]
# sample_list.append("brop")
# print(sample_list)
# print()
# sample_list.insert(["hell,ohoo"])
# print(sample_list)
...
# ['_add', 'class', 'class_getitem', 'contains', 'delattr', 'delitem', 'dir', 'doc', 'eq', 'format_', 
# '_ge', 'getattribute', 'getitem', 'getstate', 'gt', 'hash', 'iadd', 'imul', 'init', 'init_subclass_', 
# '_iter', 'le', 'len', 'lt', 'mul', 'ne', 'new', 'reduce', 'reduce_ex', 'repr', 'reversed_', 
# '_rmul', 'setattr', 'setitem', 'sizeof', 'str', 'subclasshook_', 'append', 'clear', 'copy', 'count', 'extend', 
...
# # dictnaries addition ways

# s={"name":"richu","age":22}
# s.update({"place":"calicut","roll no":"22"})
# print(s)
