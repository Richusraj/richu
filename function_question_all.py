...
'''
def company_wecome():
    print( "welcome to python fullstack")
company_wecome()
...
'''
def display_course_name(a):
    return a*3
print(display_course_name("python"))
...
'''
def show_lab_rules():
    print("Wear Proper Personal Protective Equipment (PPE)")
    print("No Food or Drink Permitted")
    print("Handle Equipment with Care") 
    print("Log Off and Secure Systems")
    print("Do Not Alter Hardware")
show_lab_rules()
...
def student_info(a):
    return a
a=input("ender your name")
b=f"hello {a} welcome to python"
