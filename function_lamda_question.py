...
'''
a=int(input("ender value : "))
b=int(input("ender value : "))
...
sample=lambda x:f"{x} is possitive" if x>0 else f"{x} is negative"
print(sample(a))
# '''
...
sample=lambda x:f"{x} is even" if x%2==0  else f"{x} is odd" 
print(sample(a))
...
sample=lambda x:f"{x} is positive" if x>0 else f"{x} is negative" if x<0 else "it's zero"
print(sample(a))
# '''
